...
public class GradientPalette extends ColorPalette {
	...
	public GradientPalette(float stepSize, Color... colors) {
	...
	public static GradientPalette fromColorPalette(ColorPalette palette, float stepSize) {
		GradientPalette gp = new GradientPalette(stepSize);
